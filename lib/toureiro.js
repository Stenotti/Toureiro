...
module.exports = function (config) {
  ...
  // app.use('/toureiro_job', require('./routes/job'));

  router.all('/queue', function (req, res) {
    console.log("QUEUE /");
  ...
  router.all('/queue/list', function (req, res) {
  ...
  router.all('/toureiro_job', function (req, res) {
    console.log("ALL /")
  ...
  router.all('/toureiro_job/remove', function (req, res) {
    console.log("remove")
  ...
  router.all('/toureiro_job/promote', function (req, res) {
    console.log("promote")
    var qName = req.body.queue;
    var id = req.body.id;
    Queue.exists(qName).then(function (result) {
  ...
  router.all('/toureiro_job/rerun', function (req, res) {
    console.log("rerun")
    var qName = req.body.queue;
    var id = req.body.id;
    Queue.exists(qName).then(function (result) {
  ...
  router.all('/toureiro_job/total/:type(((wait)|(active)|(delayed)|(completed)|(failed)))', function (req, res) {
  ...
  router.all('/toureiro_job/fetch/:type(((wait)|(active)|(delayed)|(completed)|(failed)))', function (req, res) {
