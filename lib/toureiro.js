...
module.exports = function (config) {
  ...
  app.get('/toureiro_job', function (req, res) {
    console.log("ALL /")
  ...
  app.get('/toureiro_job/remove', function (req, res) {
    console.log("remove")
  ...
  app.get('/toureiro_job/promote', function (req, res) {
    console.log("promote")
    var qName = req.body.queue;
    var id = req.body.id;
    Queue.exists(qName).then(function (result) {
  ...
  app.get('/toureiro_job/rerun', function (req, res) {
    console.log("rerun")
    var qName = req.body.queue;
    var id = req.body.id;
    Queue.exists(qName).then(function (result) {
  ...
  app.get('/toureiro_job/total/:type(((wait)|(active)|(delayed)|(completed)|(failed)))', function (req, res) {
  ...
  app.get('/toureiro_job/t_fetch/:type(((wait)|(active)|(delayed)|(completed)|(failed)))', function (req, res) {
